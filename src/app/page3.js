    ...
    <div class="page3">
      <div class="single-page">
        <div class="col first-col">
          ...
          {/* SECOND ROW */}
          <div class="data sec-data">
            <div class="data-header">ENVIAR - APROBAR - ENTREGAR</div>

            <div class="data-container">
              <div class="left-section">
                <div class="last-row">
                  <h2>Tipo deadline cliente</h2>
                  <select>
                    <option disabled selected>
                      Seleccionar...
                    </option>
              ...
              <div class="right-section">
                <span>
                  <h2>Deadline Cliente: </h2>
                  <p>2022-01-20 11:32:05</p>
                </span>
                <span class="second-span">
                  <h2>Deadline Proveedor: </h2>
                  <p> 2022-01-20 08:00:00</p>
                </span>
          ...
          {/* THIRD ROW */}
          <div class="data first-data third-data">
            <div class="data-header">FACTURACIÓN</div>
            ...
            <div class="data-container">
              ...
              <div class="right-section">
                <span>
                  <p>Fecha facturado: 16-01-22</p>
                  <p>Coste aplicado: 13,80€</p>
                  <p>Saldo Aplicado: 0,00€</p>
                  <p>Pagado: 13,80€</p>
                  <p>IVA: 2,60€</p>
                  <p>Total: 16,70€</p>
                </span>
          ...
          <div class="data last-data">
            <div class="data-header">LOG COMENTARIOS</div>

            <div class="data-container">
                    <p>- APROBADO por ProRetoque (Paz) el 2022-01-13 14:37:11 </p>
                    <p>- APROBADO por proveedor el 2022-01-14 07:03:35</p>
                    <p>- Comentarios: Done</p>
                    <p>- Valoracion Proveedor por ProRetoque: 100% el 2022-01-14 12:39:56</p>
                    <p>- Valoracion Proveedor Archivo subido: % el 2022-01-14 12:39:56</p>
                    <p>- APROBADO PARA CLIENTE por ProRetoque (Paz) el 2022-01-14 12:40:02</p>
                    <p>- COMENZANDO a zippear pedido el 2022-01-14 12:40:02</p>
                    <p>- ACABADO a zippear pedido el 2022-01-14 12:41:03</p>
            </div>
          </div>
        </div>
        <div class="col sec-col">
          <div class="data lotes">
            <div class="data-header">LOTES</div>
            <div class="data-container">
              <div class="col firs-column">
                <h2>NOMBRE</h2>
                <p>Lote 1: Lorem Isum Lorem Isum</p>
                <p>Lote 2 : Lorem Isum Lorem Isum</p>
                <p>Lote 3: Lorem Isum Lorem Isum</p>
              </div>
              <div class="col sec-column">
                <h2>PESO</h2>
                <p>35,0MB</p>
                <p>35,0MB</p>
                <p>35,0MB</p>
          ...
          <div class="data comentarios">
            <div class="data-header">COMENTARIOS INTERNOS</div>
            <div class="data-container">
              <div class="textarea-container">
                <div class="edit_text_button-container">
                  <button class="edit-text-button b-button">B</button>
          ...
          <div class="data comentarios valoracion">
            <div class="data-header">VALORACIÓN DE PROVEEDOR</div>
            <div class="data-container">
              <div class="col-container">
                <input type="text" placeholder="0 a 100..."></input>
              </div>
              ...
              <div class="col-container">
                <h2>Respuesta Rapida Proveedor</h2>
                <select>
                  <option disabled selected>
                    Seleccionar...
                  </option>
