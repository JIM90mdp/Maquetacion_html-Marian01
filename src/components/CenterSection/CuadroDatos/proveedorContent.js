...
const ProveedorContent = () => {
  return (
    <div class="tab-content proveedor_content-container">
      <div class="column first-col">
        <h2>Proveedor</h2>
        <select>
          <option>Seleccionar...</option>
        </select>
        <p>Deadline cliente</p>
        ...
        <h2>Descripción para proveedor</h2>
        <textarea
      ...
      <div class="column">
        ...
        <input
          class="input-precio"
          type="text"
          placeholder="Precio por foto proveedor..."
        />
        <input class="input-precio" type="text" placeholder="Precio $..." />

        <h2>Valoración cliente</h2>
        <input class="input-precio" type="text" placeholder="Escribir de 0 a 100..." />
        <div class="sec-column-textarea">
...
export default ProveedorContent;
